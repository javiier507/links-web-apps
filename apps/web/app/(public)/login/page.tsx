            ...
            <section id="download" className="py-24 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
                    ...
                    <form action={signInGoogle}>
                        <button
                            type="submit"
                            className="group relative flex items-center justify-center gap-3 bg-white text-dark-1 px-8 py-3.5 rounded-full font-medium text-lg shadow-xl hover:shadow-2xl hover:bg-gray-50 transition-all duration-300 mx-auto transform hover:-translate-y-0.5"
                        >
                            <svg
                                className="w-6 h-6"
                                viewBox="0 0 24 24"
